...
public class ServiceTipoInstrumentos {
	private final ClienteServidorHandler clienteServidorHandler = ClienteServidorHandler.instance();
	private static ServiceTipoInstrumentos theInstance;
	public static ServiceTipoInstrumentos instance(){
		if (theInstance == null) theInstance = new ServiceTipoInstrumentos();
		return theInstance;
	}
	private ServiceTipoInstrumentos(){
	}
	public ServiceTipoInstrumentos getInstance() {
		return theInstance;
	}
